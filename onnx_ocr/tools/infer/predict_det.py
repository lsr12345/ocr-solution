...
from tools.data import create_operators, transform
...
class TextDetector(object):
    def __init__(self, args):
        ...
        self.model = InferenceSession(args['det_model_dir'])
    ...
    def __call__(self, img):
        ...
        output_tensors = self.model.run(output_names=None, input_feed={'x': img})
        # self.predictor.run()
        outputs = []
